...
################### Edited by ice ###################################################################################################
#####################################################################################################################################
### Start_DayZ_Auto_Mod_Launcher.sh ##################################################################################################################
...
#bash ./Start_DayZ_Auto_Mod_Launcher.sh -d -l -s $ip -p $port -n $nname

#####################################################################################################################################
### Remember to remove the # in front of the commands... (echo, read, export and bash) ##############################################
#####################################################################################################################################
### Add both scripts to 'home/username' and run the 'Start_DayZ_etc.sh from terminal ######################################
#####################################################################################################################################
#####################################################################################################################################
#####################################################################################################################################
#####################################################################################################################################
